...
export class DanmuAnalysis_old extends React.Component<Props, State> {
  updateTimer: number;
  history: MessageLog<TAnyMessage>[];
  ...
  onMessage(data: string): void {
    this.setState((prevState) => {
      return this.newMessage(
        prevState,
        (JSON.parse(data) as MessageLog<TAnyMessage>).message as MessageCommand,
        new Date()
      );
    });
  }
