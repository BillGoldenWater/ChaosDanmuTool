...
use crate::config::config::frontend_config::viewer_view_config::danmu_viewer_custom_config::danmu_filter_config::DanmuFilterConfig;
use crate::config::config::frontend_config::viewer_view_config::danmu_viewer_custom_config::danmu_merge_config::DanmuMergeConfig;
use crate::config::config::frontend_config::viewer_view_config::danmu_viewer_custom_config::gift_display_config::GiftDisplayConfig;
...
#[ts(
  export,
  export_to = "../frontend/src/share/type/rust/config/frontendConfig/viewerViewConfig/"
)]
